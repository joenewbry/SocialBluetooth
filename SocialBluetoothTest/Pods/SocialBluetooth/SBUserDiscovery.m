...
- (NSMutableSet *)discoveringUsers
{
    if (!_discoveringUsers) _discoveringUsers = [NSMutableSet new];
    return _discoveringUsers;
}

- (NSMutableArray *)discoveredUsers
{
    if (!_discoveredUsers) _discoveredUsers = [NSMutableArray new];
